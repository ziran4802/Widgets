...
try {
  ...
  $base = @(
    ...
    [ordered]@{ instanceId = 'clock-date-1'; type = 'clock-date'; schemaVersion = 1; displayName = 'clock'; visible = $true; locked = $true; displayId = $null; bounds = [ordered]@{ x = 16; y = 220; width = 240; height = 112; unit = 'dip' }; theme = [ordered]@{ name = 'system'; opacity = 0.92 }; config = [ordered]@{ format = '24h'; showSeconds = $true } }
    ...
    [ordered]@{ instanceId = 'daily-todo-1'; type = 'daily-todo'; schemaVersion = 1; displayName = 'daily todo'; visible = $true; locked = $true; displayId = $null; bounds = [ordered]@{ x = 16; y = 336; width = 360; height = 420; unit = 'dip' }; theme = [ordered]@{ name = 'system'; opacity = 0.92 }; config = [ordered]@{ dateKey = (Get-Date).ToString('yyyy-MM-dd'); items = @() } }
